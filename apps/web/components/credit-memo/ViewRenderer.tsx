...
interface CreditMemoViewRendererProps {
  company?: CompanyInfo | null;
  formContentProps: formContentProps;
}

export const CreditMemoViewRenderer = memo<CreditMemoViewRendererProps>(
    ...
    return (
      ...
      >
        ...
        <div className="relative w-full">
          ...
          >
            <PayorPreview company={company} paperType="Credit Memo" />
          </div>
          ...
          >
            <EmailPreview company={company} paperType="Credit Memo" />
          </div>
          ...
          >
            <PdfPreview company={company} paperType="Credit Memo" />
          </div>
        </div>
      </div>
    );
...
CreditMemoViewRenderer.displayName = 'CreditMemoViewRenderer';
