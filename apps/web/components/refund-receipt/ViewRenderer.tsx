    ...
    return (
      ...
      >
        ...
        <div className="relative w-full">
          ...
          >
            <PayorPreview company={company} paperType="Refund Receipt" />
          </div>
          ...
          >
            <EmailPreview company={company} paperType="Refund Receipt" />
          </div>
          ...
          >
            <PdfPreview company={company} paperType="Refund Receipt" />
          </div>
        </div>
      </div>
    );
