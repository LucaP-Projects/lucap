      ...
      >
        ...
        <div className="grid grid-cols-1 gap-4 2xl:grid-cols-12">
          <div className="space-y-4 xl:col-span-7">
            <div className="max-w-125 rounded-lg border bg-white p-3 dark:border-gray-700 dark:bg-gray-800">
            ...
            {/* Attachments */}
            <div className="max-w-125 rounded-lg border bg-white p-2 dark:border-gray-700 dark:bg-gray-800">
