...
export const refundReceiptFormSchema = z.object({
  ...
  reason: z.nativeEnum(RefundReason).default(RefundReason.OTHER),
  status: z.nativeEnum(RefundStatus).default(RefundStatus.PENDING),
...
export type RefundReceiptFormValues = z.infer<typeof refundReceiptFormSchema>;
