    ...
    return (
      ...
      >
        ...
        <div className="relative w-full">
          ...
          >
            <PayorPreview company={company} paperType="Sales Receipt" />
          </div>
          ...
          >
            <EmailPreview company={company} paperType="Sales Receipt" />
          </div>
          ...
          >
            <PdfPreview company={company} paperType="Sales Receipt" />
          </div>
        </div>
      </div>
    );
