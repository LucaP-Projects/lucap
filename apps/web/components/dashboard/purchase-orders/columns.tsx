...
import { PurchaseOrderBasic } from './actions';
...
export function createPurchaseOrderColumns(): ColumnDef<PurchaseOrderBasic>[] {
  return [
    {
      id: 'select',
      header: ({ table }) => (
          ...
          <div onClick={(e) => e.stopPropagation()}>
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem onClick={() => router.push(`/purchase-orders/${item.id}`)}>
                  View Details
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
