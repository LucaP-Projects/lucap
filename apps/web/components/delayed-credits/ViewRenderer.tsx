...
interface CreditViewRendererProps {
    ...
    return (
      ...
      >
        ...
        <div className="relative w-full">
          ...
          >
            <PayorPreview company={company} paperType="Delayed Credit" />
          </div>
          ...
          >
            <EmailPreview company={company} paperType="Delayed Credit" />
          </div>
          ...
          >
            <PdfPreview company={company} paperType="Delayed Credit" />
          </div>
        </div>
      </div>
    );
...
CreditViewRenderer.displayName = 'CreditViewRenderer';
