...
import { DelayedCreditStatusSection } from '../base/customer/DelayedCreditStatusSection';
...
import { DelayedCredit } from './types';

export interface formContentProps {
  onTaxChange: (tax: TaxSelectData | null) => void;
  onSubmit: (data: DelayedCreditFormValues) => Promise<void>;
...
const MemoizedFormContent = ({
  ...
  const formMethods = useFormContext<DelayedCreditFormValues>();
