...
import { CustomerTypeRecord } from './schema';
...
export function CustomerTypeSheet({
  children,
  open,
  onOpenChange,
  onSuccess,
  customerType,
}: CustomerTypeSheetProps) {
      ...
      <SheetContent className="flex h-full w-full flex-col gap-0 p-0 sm:max-w-xl">
        <div className="flex h-full flex-col">
          <SheetHeader className="p-8 pb-4">
            ...
            <SheetDescription>
              {isEditMode
                ? 'Update your customer type details.'
                : 'Add a new customer type to categorize your customers.'}
            </SheetDescription>
          </SheetHeader>
