...
## IMPORTANT: Codebase Intelligence Instructions for LucaP
...
Last indexed: 2026-07-09 (commit 0ac4129)
### Entry Points
- `apps/web/components/delayed-credits/main.tsx`
- `apps/web/components/estimate/main.tsx`
- `apps/web/components/sales-receipt/main.tsx`
- `apps/web/components/credit-memo/main.tsx`
- `apps/web/components/refund-receipt/main.tsx`
- `apps/web/components/delayed-charges/main.tsx`
- `apps/web/components/invoice/main.tsx`
- `apps/web/components/base/customer/main.tsx`
### Tech Stack
**Languages:** Node.js, TypeScript


**Infra:** Docker Compose, Turborepo### Architectural Layers
| Layer | Files | Purpose |
|-------|-------|---------|
| Application | 190 |  |
| Config | 9 |  |
...
|------|-------|-------------|-------|
| `apps/web/components/sidebar/app-sidebar.tsx` | 99.8th %ile | 10 | Jesser Bedoui |
| `apps/web/components/payment-event/create/payment-event-create-form.tsx` | 99.7th %ile | 7 | Jesser Bedoui |
| `apps/web/components/customer/customer-form.tsx` | 99.5th %ile | 5 | Jesser Bedoui |
| `apps/web/prisma/seeds/data/planComptableGenerale.ts` | 99.3th %ile | 3 | Jesser Bedoui |
| `apps/web/components/accountant/journal/journal.tsx` | 99.1th %ile | 4 | Jesser Bedoui |
...
Defect risk, Hotspot health: 6.87/10 (stable) ·
Average: 8.19/10 ·
Worst: 1.0/10 (`apps/web/components/items/actions.ts`)
Maintainability, Average: 8.87/10
Performance risk: 24 open findings (2.96 per 10K covered LOC) · Average: 9.98/10 (a bounded [9,10] summary of the findings, not a verification claim)
...
### Critical biomarkers
- `apps/web/components/sidebar/action-button.tsx` — change entropy — impact −3.0
- `apps/web/components/company/create/actions.ts` — nested complexity (createCompany) — impact −2.5
- `apps/web/components/company/edit/actions.ts` — nested complexity (editCompany) — impact −2.5
- `apps/web/prisma/seed.ts` — churn risk — impact −2.4
- `apps/web/components/sidebar/app-sidebar.tsx` — change entropy — impact −2.4
